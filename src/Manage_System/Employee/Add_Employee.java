...
public class Add_Employee extends BaseInitManageSystem{
	...
	public static void Employee_Personal_Info(String Emp_Number, String FirstName, String MiddleName, String LastName, String Email, String WindowName, String National_Ref, String Title, String Prfix, String Suffix, String RecordPerPage, String Address1, String Address2, String City, String State, String P_Code, String Country, String Number, String Num_Type, CharSequence Notes ) throws InterruptedException 
	{
		...
		Thread.sleep(15000);
		System.out.println("New Employee Entry Start...");
	...
	//	UtilityMethods.ExplicitWait_Operation("ARCHIVE_CALENDER", operationtype.eclick, "", "XPATH");
	//	UtilityMethods.ExplicitWait_Operation("MONTH_DATE", operationtype.eclick, "", "XPATH");
	//	UtilityMethods.ExplicitWait_Operation("SEL_ARCHIVE_MONTH", operationtype.eclick, "", "XPATH");
	//	UtilityMethods.ExplicitWait_Operation("SEL_ARCHIVE_DATE", operationtype.eclick, "", "XPATH");
	//	UtilityMethods.ExplicitWait_Operation("TERMINATION_CALENDER", operationtype.eclick, "", "XPATH");
	//	UtilityMethods.ExplicitWait_Operation("MONTH_DATE", operationtype.eclick, "", "XPATH");
		//UtilityMethods.ExplicitWait_Operation("SEL_TERMINATION_MONTH", operationtype.eclick, "", "XPATH");
		//UtilityMethods.ExplicitWait_Operation("SEL_TERMINATION_DATE", operationtype.eclick, "", "XPATH");
		//UtilityMethods.ExplicitWait_Operation("RESTART_CALENDER", operationtype.eclick, "", "XPATH");
		//UtilityMethods.ExplicitWait_Operation("MONTH_DATE", operationtype.eclick, "", "XPATH");
		//UtilityMethods.ExplicitWait_Operation("SEL_RESTART_MONTH", operationtype.eclick, "", "XPATH");
		//UtilityMethods.ExplicitWait_Operation("SEL_RESTART_DATE", operationtype.eclick, "", "XPATH");
		...
		System.out.println("Employee Personal Info. Added");
